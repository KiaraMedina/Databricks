...
final_df = race_result_df.select("race_year","race_name","driver_name","race_date","circuit_location","driver_number","driver_nationanlity","team","grid","fastest_lap","race_time","points","position")
